...
export const Credentials: React.FC = () => {
  ...
  const loadCredentials = async () => {
    try {
      ...
      notify.error(error.message || 'Failed to load credentials');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      notify.error(error.message || 'Failed to search credentials');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleViewDecrypted = async (credential: Credential) => {
    try {
      ...
      notify.error(error.message || 'Failed to decrypt credential');
    }
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      notify.error(error.message || 'Failed to delete credential');
    }
  };
  ...
  const handleDeactivate = async (id: number) => {
    try {
      ...
      notify.success('Credential deactivated successfully');
      loadCredentials();
    } catch (error: any) {
      notify.error(error.message || 'Failed to deactivate credential');
    }
  };
