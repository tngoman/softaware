...
/* ───────────────────── logo to base64 ──────────────────────── */
async function logoToBase64(filename) {
    if (!filename)
        return '';
...
/* ──────────────────── build HTML template ──────────────────── */
export function buildPdfHtml(doc, co, logoDataUri) {
...
/* ──────────────────── render HTML → PDF ────────────────────── */
export async function generatePdf(doc, co) {
