 ...
 */
async function createBackup(filePath, tag) {
...
router.get('/read', async (req, res, next) => {
    try {
        ...
        // Handle line range
        const startLine = req.query.startLine ? parseInt(req.query.startLine, 10) : undefined;
        const endLine = req.query.endLine ? parseInt(req.query.endLine, 10) : undefined;
 ...
 */
router.post('/delete-lines', async (req, res, next) => {
    try {
...
router.get('/backups', async (req, res, next) => {
    try {
        ...
        let backups = await Promise.all(entries
