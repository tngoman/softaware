...
adminPackagesRouter.get('/', async (_req: Request, res: Response) => {
  try {
...
adminPackagesRouter.get('/:id', async (req: Request, res: Response) => {
  try {
...
adminPackagesRouter.post('/', async (req: Request, res: Response) => {
  try {
...
adminPackagesRouter.put('/:id', async (req: Request, res: Response) => {
  try {
    const id = parseInt(req.params.id);
    if (isNaN(id)) return res.status(400).json({ error: 'Invalid package ID' });
...
adminPackagesRouter.delete('/:id', async (req: Request, res: Response) => {
  try {
    const id = parseInt(req.params.id);
    if (isNaN(id)) return res.status(400).json({ error: 'Invalid package ID' });
...
adminPackagesRouter.get('/subscriptions/all', async (req: Request, res: Response) => {
  try {
...
adminPackagesRouter.get('/subscriptions/:contactId', async (req: Request, res: Response) => {
  try {
...
adminPackagesRouter.post('/subscriptions/assign', async (req: Request, res: Response) => {
  try {
...
adminPackagesRouter.patch('/subscriptions/:id/status', async (req: Request, res: Response) => {
  try {
    const id = parseInt(req.params.id);
...
adminPackagesRouter.post('/credits/adjust', async (req: Request, res: Response) => {
  try {
    const data = AdjustCreditsSchema.parse(req.body);
    const userId = (req as any).user?.id || null;
    const result = await packageService.adjustCredits(
      data.contact_package_id, data.amount, userId, data.reason
    );
...
adminPackagesRouter.get('/transactions/all', async (req: Request, res: Response) => {
  try {
...
adminPackagesRouter.get('/transactions/:contactId', async (req: Request, res: Response) => {
  try {
    const contactId = parseInt(req.params.contactId);
    if (isNaN(contactId)) return res.status(400).json({ error: 'Invalid contact ID' });
    const limit = req.query.limit ? parseInt(req.query.limit as string) : 50;
...
adminPackagesRouter.get('/usage/:contactId', async (req: Request, res: Response) => {
  try {
    const contactId = parseInt(req.params.contactId);
    if (isNaN(contactId)) return res.status(400).json({ error: 'Invalid contact ID' });
...
adminPackagesRouter.post('/link-user', async (req: Request, res: Response) => {
  try {
...
adminPackagesRouter.get('/contact-users/:contactId', async (req: Request, res: Response) => {
  try {
    const contactId = parseInt(req.params.contactId);
    if (isNaN(contactId)) return res.status(400).json({ error: 'Invalid contact ID' });
