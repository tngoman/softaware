...
async function callLeadAssistantModel(message: string, history: Array<{ role: 'user' | 'assistant'; content: string }> = []): Promise<AssistantResult> {
  ...
  const systemPrompt = [
    ...
    'Pricing Tiers: Free (R0 — 1 site, 1 widget, 500 AI messages/month); Starter (R349/mo — 3 sites, 3 widgets, 2,000 messages, classic CMS); Pro (R699/mo — 10 sites, 10 widgets, 5,000 messages, e-commerce); Advanced (R1,499/mo — 25 sites, 25 widgets, 20,000 messages, web apps, API webhooks); Enterprise (Custom pricing — unlimited, headless architecture, omnichannel, custom middleware).',
    'Qualify customers by asking: 1) How many websites/clients do you manage? 2) Do you need e-commerce or custom web apps? 3) Do you need API integrations or custom middleware?',
    'Be professional, technical but accessible. Quote from the defined pricing tiers only. For custom enterprise needs, guide them to Contact Sales.',
