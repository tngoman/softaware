...
async function getBankBalance(asOfDate: string): Promise<number> {
...
async function getAccountsReceivable(asOfDate: string): Promise<number> {
  const result = await db.queryOne<any>(`
...
async function getSales(startDate: string, endDate: string): Promise<number> {
  const result = await db.queryOne<any>(`
...
async function getPurchases(startDate: string, endDate: string): Promise<number> {
  const result = await db.queryOne<any>(`
...
async function getExpensesByCategory(startDate: string, endDate: string): Promise<Array<{ category: string; amount: number }>> {
...
async function getSalesFallback(startDate: string, endDate: string): Promise<number> {
  const result = await db.queryOne<any>(`
...
async function getPurchasesFallback(startDate: string, endDate: string): Promise<number> {
  const result = await db.queryOne<any>(`
...
async function getExpensesByCategoryFallback(startDate: string, endDate: string): Promise<Array<{ category: string; amount: number }>> {
  const results = await db.query<any>(`
    SELECT 
...
async function getBankBalanceFallback(asOfDate: string): Promise<number> {
  const result = await db.queryOne<any>(`
...
async function getAccountsReceivableFallback(asOfDate: string): Promise<number> {
  const result = await db.queryOne<any>(`
...
async function getRetainedEarningsFallback(asOfDate: string): Promise<number> {
...
financialReportsRouter.get('/balance-sheet', requireAuth, async (req: AuthRequest, res: Response, next) => {
  try {
    ...
    let bank: number, accountsReceivable: number, fixedAssets: number;
    let accountsPayable: number, salesTax: number, unpaidExpenses: number;
...
financialReportsRouter.get('/profit-loss', requireAuth, async (req: AuthRequest, res: Response, next) => {
  try {
    ...
    let sales: number, purchases: number;
