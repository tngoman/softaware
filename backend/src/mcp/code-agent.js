 ...
 */
export function getOrCreateCodeAgentServer(sessionId) {
 ...
 */
export function removeCodeAgentServer(sessionId) {
    serverInstances.delete(sessionId);
}
/**
 * Create a new Code Agent MCP server instance
 */
function createCodeAgentServer() {
    ...
    // Tool: read_file
    // ------------------------------------------------------------------
    server.tool('read_file', 'Read the contents of a file at the specified path', {
    ...
    // Tool: write_file
    // ------------------------------------------------------------------
    server.tool('write_file', 'Create or overwrite a file with the specified content', {
    ...
    // Tool: edit_code
    // ------------------------------------------------------------------
    server.tool('edit_code', 'Edit code in a file by replacing specific text with new text', {
    ...
    // Tool: list_directory
    // ------------------------------------------------------------------
    server.tool('list_directory', 'List files and directories at the specified path', {
    ...
    // Tool: search_files
    // ------------------------------------------------------------------
    server.tool('search_files', 'Search for text in files within the workspace', {
    ...
    // Tool: run_command
    // ------------------------------------------------------------------
    server.tool('run_command', 'Run a shell command in the workspace (with restrictions)', {
    ...
    // Tool: get_file_info
    // ------------------------------------------------------------------
    server.tool('get_file_info', 'Get metadata about a file or directory', {
    ...
    // Tool: apply_diff
    // ------------------------------------------------------------------
    server.tool('apply_diff', 'Apply multiple edits to a file at once', {
        path: z.string().describe('Path to the file to edit'),
 ...
 */
export async function connectCodeAgentToSSE(sessionId, transport) {
