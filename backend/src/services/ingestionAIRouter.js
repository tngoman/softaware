...
export async function cleanContentWithAI(rawContent, tier) {
...
// Paid: OpenRouter
// ---------------------------------------------------------------------------
async function cleanWithOpenRouter(content) {
    ...
    try {
        ...
        console.warn(`[IngestionRouter] GLM failed: ${glmErr.message} — trying OpenRouter`);
    }
    // ── 2. Try OpenRouter ──
...
// Free: Local Ollama
// ---------------------------------------------------------------------------
async function cleanWithOllama(content) {
